...
- Возможность экспорта\импорта в\из эксель файла, программа чувствительная к формату внутри экселя, смотри пример правильно заполненного эксель файла в репозитории "активы.xlsx"
